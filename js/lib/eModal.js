    ...
    define(['jquery'], function ($, root) {
        ...
        function _getModalInstance(skipEventChageIfExists) {
            ...
            function createModalElement() {
                ...
                + '<div id="callEndPopupModal" class="modal-dialog modal-lg">'
                + '<div id="callEndPopupModalContent" class=modal-content>'
        ...
        function iframe(params, title) {
            ...
            var html = ('<div class="modal-body"  style="position: absolute;width: 100%;background-color: rgba(255,255,255,0.8);height: 100%;">%1%</div>' +
                        '<iframe id="callEndPopupIframe" class="embed-responsive-item" frameborder=0 src="%0%" style="width:100%;display:block;"/>')
